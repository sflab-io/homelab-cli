...
* [`homelab help [COMMANDS]`](#homelab-help-commands)
...
```
USAGE
  $ homelab config read [KEY] [--json] [--experimental] [--log-level debug|warn|error|info|trace] [-p]
...
_See code: [src/commands/config/read.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/config/read.ts)_
...
```
USAGE
  $ homelab config write KEY VALUE [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/config/write.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/config/write.ts)_
...
```
USAGE
  $ homelab exec demo [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/exec/demo.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/exec/demo.ts)_

## `homelab help [COMMANDS]`

Display help for homelab.

```
USAGE
  $ homelab help [COMMANDS...] [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/help.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/help.ts)_
...
```
USAGE
  $ homelab module list [PROJECT-NAME] [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/module/list.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/module/list.ts)_
...
```
USAGE
  $ homelab project list [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/project/list.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/project/list.ts)_
...
```
USAGE
  $ homelab prompt demo [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
```
USAGE
  $ homelab proxmox container list [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/container/list.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/container/list.ts)_
...
```
USAGE
  $ homelab proxmox template list [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/template/list.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/template/list.ts)_
...
```
USAGE
  $ homelab proxmox vm cloudinit VMID [--json] [--experimental] [--log-level debug|warn|error|info|trace] [--ipconfig
    <value>] [--password <value>] [--ssh-key <value>] [--upgrade] [--user <value>]
...
```
USAGE
  $ homelab proxmox vm create TEMPLATE-NAME VM-NAME [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/vm/create.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/vm/create.ts)_
...
```
USAGE
  $ homelab proxmox vm delete [VMIDS...] [--json] [--experimental] [--log-level debug|warn|error|info|trace] [-f]
...
_See code: [src/commands/proxmox/vm/delete.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/vm/delete.ts)_
...
```
USAGE
  $ homelab proxmox vm list [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/vm/list.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/vm/list.ts)_
...
```
USAGE
  $ homelab proxmox vm start [VMIDS...] [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/vm/start.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/vm/start.ts)_
...
```
USAGE
  $ homelab proxmox vm stop [VMIDS...] [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/proxmox/vm/stop.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/proxmox/vm/stop.ts)_
...
```
USAGE
  $ homelab vscode [WORKSPACE-NAME] [--json] [--experimental] [--log-level debug|warn|error|info|trace]
...
_See code: [src/commands/vscode.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/vscode.ts)_
...
```
USAGE
  $ homelab zellij [MODULE-NAME] [--json] [--experimental] [--log-level debug|warn|error|info|trace] [-l
    <value>]
...
_See code: [src/commands/zellij.ts](https://github.com/sflab-io/homelab-cli/blob/v0.3.7/src/commands/zellij.ts)_
<!-- commandsstop -->
